...
const closePopupPhotoBtn = popupPhotoContainer.querySelector('.popup__close-button');
...
elementsContainer.addEventListener ('click', function (evt) {
    if (evt.target.className !== 'element__delete-button') return;
...
elementsContainer.addEventListener ('click', function (evt) {
    ...
    if (click.className !== 'element__item') return;
    ...
    popupPhotoContainer.querySelector('.popup__caption').textContent = caption.textContent;
    popupImage.src = link;
