export default class Card {
    constructor(data, cardSelector, myId, openCardImage, openPopupConfirm, likeHandler){
    ...
    cardImage.addEventListener('click', () => this._openCardImage(this._name, this._link));
    }
